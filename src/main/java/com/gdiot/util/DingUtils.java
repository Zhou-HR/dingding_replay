...
//    public static String APPKEY = "dingmjyy7k9kc8xjsm1d"; // 自动分配微应用的ID配微应用的ID
...
//	public static String APPSECRET = "gN7uhVov9Ozq9-caeqScsaCq-SOeWBsjID4VnmZgCTN2UzLRSagOFBvtYkmE4RBw";
    ...
    //钉钉回款提醒
    public static Long AGENTID = 1032008823L;
    public static String APPKEY = "ding6gwnddmyvshl7hkl";// 自动分配微应用的ID
    public static String APPSECRET = "NEdgHk-LPatLQiNxfyQR2qx47_gdsk-Q23FpeFNeuwecLLWxqJDZc1P_js-UsFHE";
    public static String PROCESS_CODE = "PROC-7CFF6983-C7BF-4F6B-9506-E5D54EE6B80E";//开票审批模板code
}
