...
import com.gdiot.util.HttpClientUtil;
...
public class NotifySendUtil {
    ...
    /**
     * 发送告警通知 String type = "sms";//voice sms String mobile = "13564017182"; String date = "2019年6月5日13时25分"; String
     * place = "上海市静安区成都北路333号招商局广场东楼25层"; SendNotify( type, mobile, date, place);
     * 
     * @author ZhouHR
     * @date 2021/01/20 19:33
     * @param type
     * @param mobile
     * @param date
     * @param place
