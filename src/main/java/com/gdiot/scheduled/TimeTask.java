...
public class TimeTask {
    ...
    /**
     * 定时任务每天凌晨1点执行一次，查询所有的用户信息 1，获取所有部门ID及子部门ID 2，获取部门下的用户ID列表 3，根据用户ID获取用户详情 4，用户详情解析，保存数据库
     */
    ...
    /**
     * 定时任务每天凌晨2点执行一次,查询所有的部门信息 查询所有的部门信息，保存数据库
     */
    // @Scheduled(cron = "0 0 0 * * ?")//每天凌晨执行一次
    ...
    /**
     * 定时任务每天凌晨3点执行一次 查询用户的开票申请单，保存数据库
     */
